...
@pytest.mark.skip(reason="Requires external ML models and GPU; intended for manual testing.")
@patch('builtins.input', return_value='all')
def test_trellis(mock_input):
...
@pytest.mark.skip(reason="Downloads heavy Shap-E models; intended for manual testing.")
@patch('builtins.input', return_value='')
@patch('requests.post')
def test_text_to_3d(mock_post, mock_input):
...
@patch('builtins.input', return_value='')
@patch('requests.post')
def test_image_to_3d(mock_post, mock_input):
